...
test_that(".parse_pairs_max() gives error when parsing a pair", {
  ...
  expect_error(.parse_pairs_max(example, list("Eigen_PC_raw", "MAP20_149bp")),
               "a stub for now")
})
...
test_that(".parse_pairs_max() returns expected tibble when parsing a single", {
  ...
  result <- .parse_pairs_max(example, list("MAP20_149bp"))
...
test_that(".parse_pairs_max() gives error when parsing a tripple", {
  ...
  expect_error(.parse_pairs_max(example, list("Eigen_PC_raw",
                                              "MAP20_149bp",
